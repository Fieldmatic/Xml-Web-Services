...
import rs.tim14.xml.model.zahtev_za_priznanje_patenta.ResenjeZahteva;
...
public class ResenjeService {
    ...
    public void obradiZahtev(ObradaZahteva obradaZahteva) throws Exception {
        ...
        zahtevZaPriznanjePatentaService.setObradjen(obradaZahteva.getId(), obradaZahteva.isOdbijen());
    }
}
