...
public class MetadataService {
	...
	String graphName = "<http://localhost:3030/XmlDataSet/data/zahtevi_za_priznanje_patenta>";
	String namespace = "http://www.ftn.uns.ac.rs/predicate/";

	public List<ZahtevZaPriznanjePatenta> dobaviPoMetapodacima(NaprednaPretragaRequest request) throws XMLDBException {
		...
		return patentRepository.getByIds(ids);
	}
