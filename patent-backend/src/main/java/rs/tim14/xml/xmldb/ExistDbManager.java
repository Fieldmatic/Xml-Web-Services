...
public class ExistDbManager {
	...
	public static List<ZahtevZaPriznanjePatenta> getAll(String collectionId) {
		Collection col = null;
		XMLResource res = null;
		try {
			List<ZahtevZaPriznanjePatenta> zahteviZaPriznanjePatenta = new ArrayList<>();
			...
			for(String s: col.listResources()){
				...
				zahteviZaPriznanjePatenta.add(JaxbParser.unmarshallFromDOM(res.getContentAsDOM()));
			}
	...
	public static ZahtevZaPriznanjePatenta getById(String id) throws XMLDBException {
