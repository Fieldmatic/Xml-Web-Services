...
public class XSLFOTransformer {
	...
	public static final String INPUT_FILE = "data/p1-primer1.xml";
	
	public static final String XSL_FILE = "data/xsl_fo/p1_fo.xsl";
	
	public static final String OUTPUT_FILE = "gen/fo/p1.pdf";
